...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFile)) {
            ...
            $created_by = $_SESSION['nama_lengkap']; // Replace with the actual created_by value
                 $sql  = "UPDATE tbl_artikel set judul='$title', img = '$targetFile', isi='$content' where id = '$id_artikel';";
